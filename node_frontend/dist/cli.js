...
const NotificationPanel = ({
  ...
  return /*#__PURE__*/React.createElement(Box, {
    ...
    color: "yellow"
  }, notification.title, ": "), /*#__PURE__*/React.createElement(Text, null, notification.message));
};
...
const App = () => {
  ...
  const [history, setHistory] = useState([{
    type: 'system',
    data: 'Initializing and connecting to backend...'
  }]);
      ...
      try {
        ...
        socket.on('message', data => {
          ...
          if (message.type === 'diff') {
            ...
            setNotification({
              title: 'Confirm',
              message: 'Apply this diff? (yes/no)'
            });
